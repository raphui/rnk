...
extern void stm32_exti_enable_interrupt(unsigned int gpio_base, unsigned int gpio_num);
...
extern void stm32_exti_disable_interrupt(unsigned int gpio_base, unsigned int gpio_num);
